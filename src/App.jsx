...
function Nav() {
  ...
  const ids   = ["apartment", "location", "experiences", "reviews", "blog", "qa", "contact"];
  return (
    <nav style={{
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
        ...
        <div style={{ display: "flex", gap: "2rem", alignItems: "center" }} className="desk-nav">
          ...
          <div style={{ display: "flex", gap: "0.25rem", borderLeft: `1px solid ${C.border}`, paddingLeft: "1rem" }}>
            ...
            <a href="https://en.casa-cavour.com/" style={{ color: C.gold, textDecoration: "none", fontSize: "0.68rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", fontFamily: "'DM Sans',sans-serif", transition: "color 0.2s", padding: "0.2rem 0.3rem" }}>EN</a>
            <span style={{ color: C.border, fontSize: "0.7rem", alignSelf: "center" }}>|</span>
        ...
        <div style={{ background: C.bg, padding: "1rem 1.5rem 1.5rem", borderTop: `1px solid ${C.border}` }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "1rem" }}>
            ...
            <div style={{ display: "flex", gap: "0.25rem", alignItems: "center" }}>
              ...
              <a href="https://en.casa-cavour.com/" style={{ color: C.gold, textDecoration: "none", fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", fontFamily: "'DM Sans',sans-serif", padding: "0.3rem 0.4rem" }}>EN</a>
              <span style={{ color: C.border, fontSize: "0.75rem" }}>|</span>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "3rem", width: "100%", paddingTop: "5rem", paddingBottom: "3rem", flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 320px", minWidth: 0 }}>
            ...
            <p style={{ opacity: loaded?1:0, transform: loaded?"translateY(0)":"translateY(24px)", transition: "all 0.85s ease 0.46s", fontSize: "clamp(0.93rem,1.8vw,1.08rem)", color: C.textMid, lineHeight: 1.82, margin: "0 0 2rem", fontFamily: "'DM Sans',sans-serif" }}>
              Casa Cavour is a design holiday apartment with fully equipped kitchen in the historic centre of Bertinoro, a medieval hilltop village in Emilia-Romagna known as the <em style={{ color: C.text }}>"Balcony of Romagna"</em> for its panoramic views over the Po Valley and Adriatic coast. Located on Via Cavour, steps from the main square and the town&apos;s famous wine-sharing tradition, it is the ideal base for couples and travellers exploring Romagna: wineries, medieval villages, Sangiovese wine, Piadina Romagnola, and the Via Emilia cultural route. Just 15 min from Cesena, 20 min from Forli, 40 min from Rimini, 35 min from San Marino, 60 min from Bologna. Available for short stays in Italian, English and Dutch.
            </p>
...
// the slugify already used for the share button, so both implementations
// stay in sync without a separate lookup map. The link always opens in a
// new tab, so the reader never loses their place in the article they're
// reading.
...
function renderTestoConLink(testo) {
  ...
  while ((match = INTERNAL_LINK_RE.exec(testo)) !== null) {
    ...
    const href = `https://en.casa-cavour.com/post/${slugify(targetId)}.html`;
    parts.push(
              ...
              <div style={{ maxWidth: 760, margin: "0 auto" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
                  ...
                  <button onClick={() => condividi(post)}
                    ...
                    onMouseEnter={e => { e.currentTarget.style.borderColor = C.gold; e.currentTarget.style.color = C.gold; }}
                    onMouseLeave={e => { e.currentTarget.style.borderColor = C.border; e.currentTarget.style.color = C.textMid; }}>
                    {shared === post.id ? "Link copied ✓" : "Share ↗"}
                  </button>
                </div>
                ...
                <div style={{ marginTop: "3rem", padding: "2rem", background: C.bg3, borderLeft: `3px solid ${C.gold}` }}>
                  <p style={{ fontFamily: "'Cormorant Garamond','Playfair Display',serif", fontSize: "1.1rem", color: C.text, marginBottom: "1rem", fontStyle: "italic" }}>
                    Want to experience authentic Romagna from Casa Cavour?
                  </p>
                  <a href="https://airbnb.com/h/casacavour-bertinoro" target="_blank" rel="noopener noreferrer"
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <Reveal>
          ...
          <p style={{ fontSize: "0.95rem", color: C.textMid, lineHeight: 1.85, fontFamily: "'DM Sans',sans-serif", textAlign: "center", maxWidth: 560, margin: "0 auto 3.5rem" }}>
            Everything you need to know before booking your stay in Bertinoro, in the heart of the Romagna hills.
          </p>
        </Reveal>
      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        <Reveal>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond','Playfair Display',serif", fontSize: "clamp(1.8rem,3.5vw,3rem)", color: C.text, fontWeight: 700, lineHeight: 1.1, marginBottom: "1rem", letterSpacing: "-0.02em" }}>
            A question before<br /><span style={{ color: C.gold, fontStyle: "italic" }}>booking?</span>
          </h2>
          <p style={{ fontSize: "0.94rem", color: C.textMid, lineHeight: 1.85, fontFamily: "'DM Sans',sans-serif", marginBottom: "2.2rem" }}>
            Write to us for availability, special requests or anything else. We usually reply within a few hours.
          </p>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              {error && (
                <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.82rem", color: "#b4453a" }}>
                  We couldn't send your message. Please try again, or message us on Instagram.
                </div>
              )}
            </form>
          )}
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "3rem", marginBottom: "3rem" }} className="footer-grid">
          ...
          <div>
            ...
            {[["Apartment","apartment"],["Location","location"],["Experiences","experiences"],["Reviews","reviews"],["Blog","blog"],["FAQ","qa"],["Contact","contact"]].map(([label, anchor]) => (
