...
const SITE_URL = "https://en.casa-cavour.com";
...
function isSocialBlock(b) {
  if (b.tipo === "titoletto" && b.testo.trim().toLowerCase() === "follow us on social media") return true;
...
// L'id è quello grezzo del post in posts.jsx (non lo slug). Stessa sintassi e
// stessa implementazione del repo IT, interpretata anche dal rendering React
// live (src/App.jsx, funzione renderTestoConLink).
...
<html lang="en">
  ...
  <body>
    <div class="wrap">
      <div class="top-nav">
        <a href="${SITE_URL}/#blog">← Back to Casa Cavour</a>
...
${bodyBlocks}
      <div class="ig-cta">
        <p>Follow us on Instagram to stay updated with new content about Bertinoro and the Romagna hills.</p>
      ...
      <footer><a href="${SITE_URL}/">Casa Cavour Bertinoro — Back to home</a></footer>
    </div>
    <script>
      (function () {
        ...
        btn.addEventListener("click", async function () {
          // url included in "text" too: some clients (e.g. email apps) only
          // read the text field and ignore url, otherwise the link would not
          // end up in the message body.
